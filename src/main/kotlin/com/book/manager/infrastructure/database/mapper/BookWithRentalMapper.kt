...
interface BookWithRentalMapper {
    ...
    @Results(
        id = "BookWithRentalRecordResult", value = [
            ...
            Result(column = "rental_date_time", property = "rentalDateTime", jdbcType = JdbcType.TIMESTAMP),
            Result(column = "rental_dead_line", property = "returnDeadLine", jdbcType = JdbcType.TIMESTAMP)
        ]
    )
